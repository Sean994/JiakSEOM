    ...
    <div>
      ...
      <div className="container">
        ...
        <div className="container-xl d-flex overflow-auto align-baseline" >
          {categoryList.map((category) => (
            <CategoryCard key={category._id} category={category} filter={filter} setFilter={setFilter} />
          ))}
        </div>
      </div>
      ...
      <div className="container">
        ...
        <div className="container-xl restContainer row">
          {restaurantList.length === 0 ? <span>Sorry, no restaurants fit the criteria</span>: null}
